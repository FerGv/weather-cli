...
var WeatherApi = /** @class */ (function () {
    function WeatherApi() {
        this.request = axios_1.default.create({
            baseURL: config_1.default.API_URL,
        });
    }
    /**
     ...
     */
    WeatherApi.prototype.getCurrentWeather = function (city) {
        return __awaiter(this, void 0, void 0, function () {
            var res, _a, location_1, current, rows, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.request.get('current.json', {
                                params: {
                                    key: config_1.default.API_KEY,
                                    q: city,
                                },
                            })];
                    case 1:
